...
const QUESTION_BY_FIELD: { field: keyof QualificationFields; ask: string }[] = [
  ...
  { field: "current_process", ask: "How does that work today, step by step?" },
  { field: "frequency", ask: "How often does that happen?" },
  { field: "people_involved", ask: "How many people touch that process?" },
  { field: "consequence", ask: "What does it cost you when it goes wrong?" },
