...
const FACTS: Record<Exclude<ReceptionistIntent, "unknown">, KnowledgeFact[]> = {
  company_overview: [
    { id: "company.identity", text: `${COMPANY_FACTS.name} identifies avoidable operational loss, quantifies it, and helps recover persistent value.`, source: "src/lib/site.ts" },
    { id: "company.audience", text: APPROVED_AUDIENCE, source: "src/lib/site.ts + industry pages" },
  ],
  services: APPROVED_SERVICES.map((s) => ({
    id: `service.${s.slug}`,
  ...
  pricing: [
    { id: "pricing.fit_review", text: APPROVED_PRICING.fit_review, source: "src/app/contact/page.tsx" },
    { id: "pricing.audit", text: APPROVED_PRICING.paid_audit, source: "src/app/contact/page.tsx" },
    { id: "pricing.boundary", text: APPROVED_PRICING.note, source: "src/app/contact/page.tsx" },
  ],
  ...
  implementation: [
    ...
    { id: "implementation.boundary", text: "Diagnosis is separate from implementation.", source: "src/lib/commercial-services.ts" },
  ],
