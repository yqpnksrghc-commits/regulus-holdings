...
export function buildSystemPrompt(sourcePage: string | null): string {
  ...
  return [
    ...
    `1. You may state ONLY the facts in the APPROVED KNOWLEDGE below, or deterministic facts the application gives you. If asked something not covered, say a Regulus team member will confirm — never guess or use general knowledge about Regulus.`,
    ...
    `7. Collect only what's offered. Ask at most one question per turn. Be concise and professional.`,
    ``,
